...
const HISTORIAL_EVENTOS = {
  "VIA-2025-001": [
    { id:1, ts:"2025-05-10 08:12", tipo:"creacion",    usuario:"Ing. Ramírez Mejía",   av:"RM", ip:"192.168.1.18", accion:"Solicitud creada", detalle:"Formulario completado — Santiago, RD$4,500", hash:"a3f7c2d1" },
    { id:2, ts:"2025-05-10 09:30", tipo:"validacion",  usuario:"Sistema SIVIARD",       av:"SY", ip:"Sistema",       accion:"Validación geográfica", detalle:"Nominatim/OSRM — 155 km — ruta elegible", hash:"b82e4f09" },
    { id:3, ts:"2025-05-11 10:05", tipo:"revision",    usuario:"Dir. García Núñez",     av:"GN", ip:"192.168.1.5",  accion:"Revisión de supervisor", detalle:"Documentos verificados — sin observaciones", hash:"c19d3a77" },
    { id:4, ts:"2025-05-12 14:22", tipo:"aprobacion",  usuario:"Dpto. Finanzas",        av:"DF", ip:"192.168.1.22", accion:"Aprobación financiera", detalle:"Presupuesto disponible confirmado — RD$4,500", hash:"d50b6e23" },
    { id:5, ts:"2025-05-15 14:00", tipo:"desembolso",  usuario:"Tesorería",             av:"TS", ip:"192.168.1.30", accion:"Desembolso ejecutado", detalle:"Transferencia completada — Cuenta #****4821", hash:"e77f1c88" },
  ],
  "VIA-2025-002": [
    { id:1, ts:"2025-05-12 07:45", tipo:"creacion",    usuario:"Lic. Pérez Santos",     av:"PS", ip:"192.168.1.31", accion:"Solicitud creada", detalle:"Formulario completado — La Vega, RD$3,200", hash:"f03a9b14" },
    { id:2, ts:"2025-05-12 08:10", tipo:"validacion",  usuario:"Sistema SIVIARD",       av:"SY", ip:"Sistema",       accion:"Validación geográfica", detalle:"OSRM — 120 km — ruta elegible", hash:"g21c7d55" },
    { id:3, ts:"2025-05-13 11:00", tipo:"pendiente",   usuario:"Dir. Martínez Ruiz",    av:"MR", ip:"192.168.1.5",  accion:"En espera de aprobación", detalle:"Pendiente firma del supervisor responsable", hash:"h94e2f31" },
  ],
  "VIA-2025-003": [
    { id:1, ts:"2025-05-13 09:00", tipo:"creacion",    usuario:"Dra. Vargas Díaz",      av:"VD", ip:"192.168.1.47", accion:"Solicitud creada", detalle:"Formulario completado — San Pedro, RD$5,800", hash:"i67b3a92" },
    { id:2, ts:"2025-05-13 09:18", tipo:"validacion",  usuario:"Sistema SIVIARD",       av:"SY", ip:"Sistema",       accion:"Validación geográfica", detalle:"OSRM — 75 km — ruta elegible", hash:"j40d8c63" },
    { id:3, ts:"2025-05-15 17:30", tipo:"revision",    usuario:"Dpto. Finanzas",        av:"DF", ip:"192.168.1.22", accion:"En revisión financiera", detalle:"Verificando disponibilidad presupuestaria — Salud Pública", hash:"k15e5b74" },
  ],
  "VIA-2025-004": [
    { id:1, ts:"2025-05-14 10:30", tipo:"creacion",    usuario:"Sr. Torres Cabral",     av:"TC", ip:"192.168.1.52", accion:"Solicitud creada", detalle:"Formulario completado — Distrito Nacional", hash:"l28f9a05" },
    { id:2, ts:"2025-05-14 10:31", tipo:"bloqueo",     usuario:"Sistema SIVIARD",       av:"SY", ip:"Sistema",       accion:"Bloqueo automático — Decreto 685-00", detalle:"Destino dentro del perímetro GSD/DN — no elegible para viáticos", hash:"m91c4d16" },
    { id:3, ts:"2025-05-16 09:15", tipo:"rechazo",     usuario:"Sistema SIVIARD",       av:"SY", ip:"Sistema",       accion:"Rechazo definitivo registrado", detalle:"Evento auditado — notificación enviada al solicitante", hash:"n74b2e87" },
  ],
  "VIA-2025-005": [
    { id:1, ts:"2025-05-15 08:00", tipo:"creacion",    usuario:"Arq. Guzmán Peña",      av:"GP", ip:"192.168.1.13", accion:"Solicitud creada", detalle:"Formulario completado — Puerto Plata, RD$6,200", hash:"o58a7f28" },
    { id:2, ts:"2025-05-15 08:14", tipo:"validacion",  usuario:"Sistema SIVIARD",       av:"SY", ip:"Sistema",       accion:"Validación geográfica", detalle:"OSRM — 215 km — ruta elegible", hash:"p37d1c49" },
    { id:3, ts:"2025-05-15 10:45", tipo:"revision",    usuario:"Dir. Castillo Reyes",   av:"CR", ip:"192.168.1.8",  accion:"Aprobación del supervisor", detalle:"Revisión completa — proyecto costero turístico validado", hash:"q12e8b60" },
    { id:4, ts:"2025-05-16 09:42", tipo:"aprobacion",  usuario:"Adm. Carlos Medina",    av:"CM", ip:"192.168.1.10", accion:"Aprobación final", detalle:"Autorización ejecutiva — desembolso programado", hash:"r85f3a71" },
  ],
  "VIA-2025-006": [
    { id:1, ts:"2025-05-16 08:55", tipo:"creacion",    usuario:"Prof. Montero Silva",   av:"MS", ip:"192.168.1.44", accion:"Solicitud creada", detalle:"Formulario completado — Barahona, RD$7,100", hash:"s64c9d82" },
    { id:2, ts:"2025-05-16 09:02", tipo:"validacion",  usuario:"Sistema SIVIARD",       av:"SY", ip:"Sistema",       accion:"Validación geográfica", detalle:"OSRM — 198 km — ruta elegible", hash:"t43b6e93" },
  ],
};

const TIPO_EVENTO = {
  creacion:   { color:"#2563EB", bg:"rgba(37,99,235,.12)",    label:"Creación",      ic:FilePlus2     },
  validacion: { color:"#06B6D4", bg:"rgba(6,182,212,.12)",    label:"Validación",    ic:MapPin        },
  revision:   { color:"#F59E0B", bg:"rgba(245,158,11,.12)",   label:"Revisión",      ic:ScanLine      },
  aprobacion: { color:"#10B981", bg:"rgba(16,185,129,.12)",   label:"Aprobación",    ic:CircleCheck   },
  desembolso: { color:"#8B5CF6", bg:"rgba(139,92,246,.12)",   label:"Desembolso",    ic:DollarSign    },
  pendiente:  { color:"#94A3B8", bg:"rgba(148,163,184,.12)",  label:"Pendiente",     ic:Clock         },
  bloqueo:    { color:"#EF4444", bg:"rgba(239,68,68,.12)",    label:"Bloqueo",       ic:FileLock2     },
  rechazo:    { color:"#EF4444", bg:"rgba(239,68,68,.12)",    label:"Rechazo",       ic:XCircle       },
};
...
/* ─── PAGE COMPONENTS (moved outside SIVIARD to prevent remount on each render) ─── */
...
function Aprobacion({ ctx }) {
  ...
  return (
  <div style={{ animation:"fadeUp .42s cubic-bezier(.22,1,.36,1)", fontFamily:"'DM Sans',system-ui,sans-serif", overflow:"visible" }}>

    {/* ── HEADER ── */}
    <div style={{ marginBottom:26 }}>
      <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", gap:11, marginBottom:5, flexWrap:"wrap" }}>
        <div style={{ display:"flex", alignItems:"center", gap:11, minWidth:0 }}>
          <div style={{ width:4, height:24, borderRadius:2, background:"linear-gradient(180deg,#F59E0B,#EF4444)", flexShrink:0 }} />
          <h2 style={{ fontSize:23, fontWeight:900, color:TXT, letterSpacing:-.7, whiteSpace:"nowrap" }}>Panel de Aprobaciones</h2>
        </div>
        {/* EDIT FLOW BUTTON */}
        <button
          className="act-btn"
          onClick={() => setFlujoModalOpen(true)}
          style={{ padding:"9px 18px", background:"linear-gradient(135deg,rgba(139,92,246,.18),rgba(37,99,235,.18))", border:"1px solid rgba(139,92,246,.35)", borderRadius:12, color:"#A78BFA", fontSize:12, fontWeight:800, justifyContent:"center", gap:7, backdropFilter:"blur(8px)", flexShrink:0, whiteSpace:"nowrap" }}
        >
    ...
    <div style={{ background:CARD, border:`1px solid ${BDR}`, borderRadius:18, padding:26, marginBottom:22, overflow:"visible", position:"relative" }}>
      ...
      <div style={{ display:"flex", alignItems:"flex-start", overflowX:"auto", gap:0, paddingBottom:8, paddingTop:14, paddingRight:14, position:"relative" }}>
